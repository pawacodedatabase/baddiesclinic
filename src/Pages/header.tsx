...
const Header: React.FC = () => {
  ...
  return (
    <><MovingText/>
    <header className="bg-[#000]  py-4 px-4 sticky top-0 z-50">
      <div className="max-w-screen-xl mx-auto  flex items-center justify-between">
        ...
        <div className="md:hidden flex items-center">
          ...
          >
            <motion.button
              ...
              className="relative h-10 w-10 rounded-full bg-black/0 transition-colors hover:bg-yellow/50 focus:outline-none"
            >
              <motion.span
                variants={VARIANTS.top}
                className="absolute h-1 w-6 bg-[#FFD700]"
                style={{ y: "-50%", left: "50%", x: "-50%", top: "35%" }}
              />
              <motion.span
                variants={VARIANTS.middle}
                className="absolute h-1 w-5 bg-[#FFD700]"
                style={{ left: "50%", x: "-50%", top: "50%", y: "-50%" }}
              />
              <motion.span
                variants={VARIANTS.bottom}
                className="absolute h-1 w-4 bg-[#FFD700]"
                style={{
                  x: "-50%",
                  y: "50%",
                  bottom: "35%",
        ...
        <div className="flex items-center space-x-2 text-xl ">
          <Link to="/wishlist" className="text-[#FFD700]  hover:font-bold hover:text-white transition-colors duration-300">
            <FiHeart  />
          </Link>
          <Link to="/cart" className="text-[#FFD700]  hover:font-bold hover:text-white transition-colors duration-300">
            <FiShoppingCart  />
          </Link>

          <Link
            to="/shop"
            className="text-[#FFD700]  hover:font-bold hover:text-white  transition-colors duration-300"
          >
            <FiShoppingBag/> 
          </Link>
        </div>
