...
const BIN_ID = "687e72d97b4b8670d8a4f140"; // Your bin ID
...
export default function ProductPage() {
  ...
  return (
    <>
   <BusinessPopup/>
    <div className="relative"> <h1 className="text-2xl font-bold font-graffiti bg-  text-gray-700 text-center p-4"> <span className="text-[#FFD700]">OUR</span> COLLECTIONS</h1>
                ...
                <div className="flex justify-between p-4 border-t border-gray-200">
                  {cartItem ? (
                    ...
                    <button
                      ...
                      className="bg-[#000000] text-[#FFD700] px-3 py-1 hover:bg-[#aab7b7] hover:text-black transition"
                    >
