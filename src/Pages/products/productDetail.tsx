...
const BIN_ID = "687e72d97b4b8670d8a4f140"; // Your JSONBin ID
        ...
        {isLoading ? (
          ...
          product && (
            <div>
              ...
              <div className="mt-6">
               <h1 className="text-3xl font-bold text-center font-graffiti drop-shadow-[2px_2px_0_black]">
...
>
  ...
  <h1 className="text-3xl font-bold text-gray-800 text-center font-graffiti ">
    <span className="text-[#FFD700]  drop-shadow-[2px_2px_0_black]">About</span> Baddies Clinic
  </h1>

  <p className="text-sm text-gray-800 mt-2 text-center">
    Baddies Clinic is your go-to destination for premium hair services and luxury styles. 
    We specialize in high-end wigs, braided hairstyles, and expertly crafted dreadlocks for both men and women. 
    Our mission is to make everyone feel bold, beautiful, and confidently baddie without compromise.
  </p>
</div>
