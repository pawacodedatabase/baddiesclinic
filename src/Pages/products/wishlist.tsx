...
const Wishlist: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await fetch("https://api.jsonbin.io/v3/b/687e72d97b4b8670d8a4f140/latest", {
          headers: {
      ...
      <div className="container mx-auto p-6">
        ...
        {wishlist.length === 0 ? (
          <div className="flex flex-col items-center justify-center mt-16">
            ...
            <Link
              to="/shop"
              className="mt-4 bg-black text-white py-2 px-6 rounded-lg hover:bg-gray-700 transition duration-300"
            >
              Browse Products
            </Link>
          </div>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between mt-4">
                      {/* Add to Cart */}
                      <button
                        className="bg-black text-white py-2 px-4 rounded-lg hover:bg-gray-700 transition duration-300 flex items-center gap-2"
